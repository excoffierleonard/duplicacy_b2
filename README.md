...
> ⚠️ **Warning**: In the case where you use an `.env` and you wish to not use the `THREADS` or `TZ` environment variable: you must delete their lines from (or simply not include them in) the [compose.yaml](compose.yaml).
